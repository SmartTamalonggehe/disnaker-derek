...
!(function (t, e) {
    ...
    class Z extends B {
        ...
        to(t) {
            ...
            if (this._isSliding)
                return void R.one(this._element, "slid.bs.carousel", () =>
                    this.to(t)
                );
        ...
        _addEventListeners() {
            this._config.keyboard &&
                R.on(this._element, "keydown.bs.carousel", (t) =>
                    this._keydown(t)
                ),
                "hover" === this._config.pause &&
                    (R.on(this._element, "mouseenter.bs.carousel", (t) =>
                        this.pause(t)
                    ),
                    R.on(this._element, "mouseleave.bs.carousel", (t) =>
                        this.cycle(t)
                    )),
                this._config.touch &&
                    this._touchSupported &&
        ...
        _addTouchEventListeners() {
            ...
            W.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? (R.on(this._element, "pointerdown.bs.carousel", (e) =>
                          t(e)
                      ),
                      R.on(this._element, "pointerup.bs.carousel", (t) => s(t)),
                      this._element.classList.add("pointer-event"))
                    : (R.on(this._element, "touchstart.bs.carousel", (e) =>
                          t(e)
                      ),
        ...
        _getItemIndex(t) {
            return (
                (this._items =
                    t && t.parentNode
                        ? W.find(".carousel-item", t.parentNode)
                        : []),
        ...
        _slide(t, e) {
            ...
            if (o && o.classList.contains("active")) this._isSliding = !1;
                ...
                !this._triggerSlideEvent(o, g).defaultPrevented &&
                i &&
                o
            ) {
                if (
    ...
    class dt extends B {
        ...
        show() {
            ...
            if (
                !R.trigger(this._element, "show.bs.dropdown", e)
                    .defaultPrevented
            ) {
                if (this._inNavbar)
    ...
    class Tt extends B {
        ...
        hide(t) {
            ...
            if (
                ...
                R.one(this._element, "transitionend", (t) =>
                    this._hideModal(t)
                ),
                    h(this._element, t);
        ...
        _showElement(t) {
            ...
            const i = () => {
                this._config.focus && this._element.focus(),
                    (this._isTransitioning = !1),
                    R.trigger(this._element, "shown.bs.modal", {
                        relatedTarget: t,
                    });
            };
            if (e) {
        ...
        _triggerBackdropTransition() {
            if (
                R.trigger(this._element, "hidePrevented.bs.modal")
                    .defaultPrevented
            )
                return;
            const t =
    ...
    class kt extends B {
        ...
        show(t) {
            ...
            if (
                R.trigger(this._element, "show.bs.offcanvas", {
                    relatedTarget: t,
                }).defaultPrevented
            )
                return;
    ...
    const Ct = new Set([
        ...
        Nt = (t, e) => {
            ...
            if (e.includes(s))
                return (
                    !Ct.has(s) ||
                    Boolean(Dt.test(t.nodeValue) || St.test(t.nodeValue))
                );
    ...
    class Rt extends B {
        ...
        hide() {
            ...
            if (
                !R.trigger(this._element, this.constructor.Event.HIDE)
                    .defaultPrevented
            ) {
                if (
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach((t) => {
                if ("click" === t)
                    ...
                    R.on(this._element, e, this.config.selector, (t) =>
                        this._enter(t)
                    ),
                        R.on(this._element, s, this.config.selector, (t) =>
                            this._leave(t)
                        );
                }
            }),
        ...
        _getConfig(t) {
            ...
            return (
                ...
                t.sanitize &&
                    (t.template = Ot(t.template, t.allowList, t.sanitizeFn)),
                t
            );
        }
        _getDelegateConfig() {
    ...
    class Yt extends B {
        constructor(t, e) {
            super(t),
                ...
                R.on(this._scrollElement, "scroll.bs.scrollspy", () =>
                    this._process()
                ),
                this.refresh(),
                this._process();
