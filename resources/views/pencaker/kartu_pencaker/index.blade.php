		  ...
		  <div class="box">
			...
			<div class="box-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-lg-3 col-md-4 col-xs-6">
                                    <a class="image-popup-vertical-fit" href="{{asset('storage/pencaker/' .$kartu_kuning->pencaker->foto)}}" title="foto Lowongan">
                                        <img src="{{asset('storage/pencaker/' .$kartu_kuning->pencaker->foto)}}" class="img-fluid" alt=""  />
                                    </a>
                                </div>
                            </td>
                        </tr>
              ...
              <div class="btn btn-warning mt-3">
                <a href="{{ route('CetakKartu')}}"><i class="fa  fa-print"> Cetak Kartu Pencaker</i> </a>
                </div>
			</div>
			<!-- /.box-body -->
