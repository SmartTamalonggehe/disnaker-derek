        ...
        @if (!$persyaratan)
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{ route('persyaratan.store') }}" enctype="multipart/form-data" method="post"
                                novalidate>
                                @csrf
                                <div class="row">
                                    <div class="col-12">
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="box">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="col-lg-3 col-md-4 col-xs-6">
                                        <a class="image-popup-vertical-fit"
                                            href="{{ asset('storage/persyaratan/ktp/' . $persyaratan->ktp) }}"
                                            title="ktp ">
                                            <img src="{{ asset('storage/persyaratan/ktp/' . $persyaratan->ktp) }}"
                                                class="img-fluid" alt="" />
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-lg-3 col-md-4 col-xs-6">
                                        <a class="image-popup-vertical-fit"
                                            href="{{ asset('storage/persyaratan/ijazah/' . $persyaratan->ijasah) }}"
                                            title="ijasah ">
                                            <img src="{{ asset('storage/persyaratan/ijazah/' . $persyaratan->ijasah) }}"
                                                class="img-fluid" alt="" />
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-lg-3 col-md-4 col-xs-6">
                                        <a class="image-popup-vertical-fit"
                                            href="{{ asset('storage/persyaratan/sertifikat/' . $persyaratan->sertifikat) }}"
                                            title="sertifikat ">
                                            <img src="{{ asset('storage/persyaratan/sertifikat/' . $persyaratan->sertifikat) }}"
                                                class="img-fluid" alt="" />
                                        </a>
                                    </div>
                                </td>
                    ...
                    <div class="box-footer">
                        <a href="{{ route('pendidikan.index') }}"><button type="submit" class="btn btn-warning">
                                Previous</button></a>
